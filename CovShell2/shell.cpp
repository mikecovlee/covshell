...
// 显示的Build版本设置
static string buildver = "15-04-301-01";
// 显示的Shell版本设置
static string shellver = "3.0.1";
// 其他源文件
#include"headfiles/support.h"
#include"headfiles/variable.h"
#include"headfiles/shell.h"
// 独立函数体
